...
//     private float[] wallBorders = {25,-26,25,-26};
//     private float X = 1;
//     private float Z = 1;
...
//     private bool run;
    ...
    //             float newXPosition = transform.localPosition.x + horizontalInput * 7f * Time.deltaTime;
    //             newXPosition = Mathf.Clamp(newXPosition, wallBorders[1], wallBorders[0]);                
    //             float newZPosition = transform.localPosition.z + verticalInput * 7f * Time.deltaTime;
    ...
    //             float newXPosition = transform.localPosition.x + horizontalInput * table.getTargetSpeed * Time.deltaTime * X;
    //             float newZPosition = transform.localPosition.z + verticalInput * table.getTargetSpeed * Time.deltaTime * Z;
