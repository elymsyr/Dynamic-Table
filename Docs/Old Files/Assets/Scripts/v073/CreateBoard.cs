...
public class CreateBoard2 : MonoBehaviour
{
    ...
    public void ObjectPos(){
        ...
        if(wallsArray[0] == null){Debug.Log(wallsArray[0]);}
        if(wallsArray[1] == null){Debug.Log(wallsArray[1]);}
        if(wallsArray[2] == null){Debug.Log(wallsArray[2]);}
        if(wallsArray[3] == null){Debug.Log(wallsArray[3]);}
        if(target == null){Debug.Log(target);}
        if(gameObject == null){Debug.Log(gameObject);}
        if(productClass == null){Debug.Log(productClass);}
