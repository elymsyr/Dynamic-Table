...
public class CreateBoard : MonoBehaviour
{
    ...
    private Vector3 randomPos(){
        return new Vector3(Random.Range(wallBorders[0]-(scale/2)-0.5f, wallBorders[1]+(scale/2)+0.5f), 8f, Random.Range(wallBorders[2]-(scale/2)-0.5f, wallBorders[3]+(scale/2)+0.5f));
    }    
